...
CREATE TABLE `users` (
  ...
  `roles` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'user' COMMENT '(DC2Type:json)',
  `password` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `username` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `profil_pic` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'public\\images\\profil\\default.png',
...
-- Dump completed on 2023-05-24  0:11:14
